...
var settings = {
	...
	forcePasteAsPlainText: { desc: 'Whether to force all pasting operations to insert on plain text into the editor, losing any formatting information possibly available in the source text.', type: 'bool', val: 'n' },
