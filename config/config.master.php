...
if (isset($config))
{
	...
	$env_config['encryption_key']      = 'fc7b3759f69cfb958abcfa0d11a297c4c9716e3e';
	$env_config['session_crypt_key']   = '02fc051991c05f50967ea4be77d9426e9a718588';
	...
	$env_config['show_ee_news'] = 'n';
	$env_config['share_analytics'] = 'y';
